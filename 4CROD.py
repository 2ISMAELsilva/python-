...
def atulizar_clientes(lista_clientes):
    ...
    if cliente_para_atualizar:
        ...
        print(f'\nDados dos clientes: {nome_buscar} atualizados com sucesso!!')
    else:
        print(f'Cliente com nome: {nome_buscar} não encontrado. ')
...
def  excluir_cliente(lista_cliente): 
    ...
    nome_buscar = input('Digite o nome de usuario que deseja buscar: ')
